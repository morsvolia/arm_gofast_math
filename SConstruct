...
tool_path = '/opt/bleeding-edge-arm-4_9/'
...
cm3_env = env.Clone()
cm3_env.Append(CCFLAGS=cm3_sw,CXXFLAGS=cm3_sw,LINKFLAGS=cm3_sw,ASFLAGS=cm3_sw,CPPDEFINES=['ARM_MATH_CM3'])
...
env.SConscript(src_dir+scr_file, exports={'env':cm3_env,'cm_postfix':'M3'}, variant_dir=cm3_dir, duplicate=0)
